...
const calculateOutputs = (register) => {
  const output0 = register.get("output 0")[0];
  const output1 = register.get("output 1")[0];
  const output2 = register.get("output 2")[0];
...
const solvePuzzle = (input) => {
  ...
  return calculateOutputs(register);
};
